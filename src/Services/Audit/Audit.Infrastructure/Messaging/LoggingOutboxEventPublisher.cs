...
/// sending it to a real broker. CLAUDE.md §7 explicitly allows "a documented
/// in-memory bus" for local dev with no production credentials required.
/// Swapping this for an Azure Service Bus implementation (Phase 7 — local
/// infra/emulator, or the eventual cloud deployment) is a single DI
/// registration change; <see cref="OutboxProcessor"/> does not change.
/// </summary>
