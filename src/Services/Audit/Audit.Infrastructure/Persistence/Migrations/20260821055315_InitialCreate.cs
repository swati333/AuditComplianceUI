    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuditStatusHistories_Audits_AuditId",
                        column: x => x.AuditId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistResponses_Audits_AuditId",
                        column: x => x.AuditId,
                        principalTable: "Audits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditStatusHistories_AuditId",
                table: "AuditStatusHistories",
                column: "AuditId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditTeamMembers_AuditId_UserId_Role",
                table: "AuditTeamMembers",
                columns: new[] { "AuditId", "UserId", "Role" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistQuestions_ChecklistId_DisplayOrder",
                table: "ChecklistQuestions",
                columns: new[] { "ChecklistId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistResponses_AuditId_ChecklistQuestionId",
                table: "ChecklistResponses",
                columns: new[] { "AuditId", "ChecklistQuestionId" },
                unique: true);
