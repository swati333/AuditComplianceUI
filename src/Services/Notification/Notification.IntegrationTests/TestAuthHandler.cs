...
/// handler for the full rationale. <see cref="UserIdHeader"/> matters more
/// here than for Audit/Finding since NotificationPreferencesController
/// checks the caller's <c>oid</c> against the route's <c>userId</c>.
/// </summary>
