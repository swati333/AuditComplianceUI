...
import { assignTeamMemberSchema, type AssignTeamMemberFormValues } from '@/features/audits/schemas';
...
export function AssignTeamMemberDialog({
  ...
  async function onSubmit(values: AssignTeamMemberFormValues) {
    try {
        ...
        <Stack component="form" onSubmit={form.handleSubmit(onSubmit)} noValidate>
          <DialogContent>
            <Stack spacing={2}>
              ...
              <FormTextField<AssignTeamMemberFormValues>
                name="displayName"
                label="Display name"
                required
                autoFocus
              ...
              <FormTextField<AssignTeamMemberFormValues>
                name="userId"
                label="User ID (Entra object ID)"
                required
              />
              <FormSelect<AssignTeamMemberFormValues>
                name="role"
                label="Role"
                required
                options={[
