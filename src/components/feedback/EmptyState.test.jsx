...
describe('EmptyState', () => {
    it('renders the title and description', () => {
        renderWithProviders(<EmptyState title="No audits found" description="Try clearing your filters."/>);
    ...
    it('invokes onAction when the action button is clicked', async () => {
        ...
        renderWithProviders(<EmptyState title="No audits" actionLabel="Create audit" onAction={onAction}/>);
