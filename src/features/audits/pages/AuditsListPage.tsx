...
import type { AuditSummary } from '@/features/audits/types';
...
function filtersFromParams(searchParams: URLSearchParams): AuditFilters {
  return {
    ...
    status: (searchParams.get('status') as AuditStatus | null) ?? '',
      ...
      {isError ? (
        ...
        <Box>
          <DataTable
            ...
            emptyDescription="Try clearing your filters, or create a new audit to get started."
          />
        </Box>
      )}
    </Stack>
