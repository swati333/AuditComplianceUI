...
const baseFilters: FindingFilters = { searchText: '', auditId: '', status: '', severity: '' };
...
describe('FindingFilterPanel', () => {
  it('reports search text changes', async () => {
    ...
    renderWithProviders(
      <FindingFilterPanel filters={baseFilters} onChange={onChange} onRefresh={vi.fn()} />,
    );
  ...
  it('calls onRefresh when the refresh button is clicked', async () => {
    ...
    renderWithProviders(
      <FindingFilterPanel filters={baseFilters} onChange={vi.fn()} onRefresh={onRefresh} />,
    );
