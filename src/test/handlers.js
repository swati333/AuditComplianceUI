...
export const handlers = [
    ...
    http.get(`${serviceBaseUrls.finding}/findings`, () => HttpResponse.json(pagedResult(sampleFindings))),
    http.get(`${serviceBaseUrls.notification}/notifications`, () => HttpResponse.json(pagedResult([]))),
];
